...
if (isset($_SESSION['rationcard_no'])) {
    ...
    $sql2 = "SELECT ts.*, tas.quantity as available_quantity FROM tbl_stock ts JOIN tbl_available_stock tas ON ts.stock_id = tas.stock_id";
    $result2 = mysqli_query($conn, $sql2);

    $sql3 = "SELECT ts.*, tas.quantity as available_quantity FROM tbl_stock ts JOIN tbl_available_stock tas ON ts.stock_id = tas.stock_id";
                                            ...
                                            <div class="w3-container">
                                                ...
                                                <div class="w3-margin-top">
                                                    ...
                                                    if ($row['stock_name'] != "Oil") {
                                                        ?>
                                                        <p>Quantity :
                                                            <?php echo $row['available_quantity']; ?> KG
                                                        </P>
                                                        <?php
                                                    } else { ?>
                                                        <p>Quantity :
                                                            <?php echo $row['available_quantity']; ?> Litres
                                                        </P>
                                                        <?php } ?>
                                                    <p>Total Members : 4 Persons</P>
                                                    <?php
                                                    $total_quantity = $row['available_quantity'] * 4;
                                                    if ($row['stock_name'] != "Oil") {
                                                        ?>
                                                        <p>Total Quantity :
                                                        ...
                                                        <p>Total Quantity :
                                                            <?php echo $total_quantity; ?> Litres
                                                        </P>
                                                        <?php } ?>
                                                    <?php
                                                    if ($row['stock_name'] != "Oil") {
                                                        ?>
                                                        <p>Price Per KG :
                                                            <?php echo $row['stock_price']; ?> Rupees
                                                        </P>
                                                        <?php
                                                    } else { ?>
                                                        <p>Price Per Litres :
                                                    ...
                                                    <p style="font-size:1.3rem;margin-top:0.8rem;"><b>Amount :
                                                            <?php echo $row['stock_price'] * $total_quantity; ?> Rupees
                                                        </b></p>
                                                </div>
                                            </div>
                                ...
                                if (count($_SESSION['cart']) >= 1) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result3)) {
                                        foreach ($product_id as $id) {
                                            ...
                                            if ($stock_id == $id) {
                                                $total_quantity = $row['available_quantity'] * 4;
                                                $total = $row['stock_price'] * $total_quantity;
                                                ?>
                                                <tr>
                                                    ...
                                                    if ($row['stock_name'] != "Oil") {
                                                        ?>
                                                        <td data-label="Quantity"><?php echo ($total_quantity) . "/KG"; ?></td>
                                                        <?php
                                                    } else { ?>
                                                        <td data-label="Quantity"><?php echo ($total_quantity) . "/Litres"; ?></td>
                                                        <?php } ?>
