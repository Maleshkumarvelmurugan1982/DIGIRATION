    ...
    if(isset($_REQUEST['submit'])) {
        foreach($rows as $row) {
            ...
            foreach($details as $detail) {
                ...
                $sql3 = "INSERT INTO tbl_give_stock (pds_no, stock_name, quantity, date) 
                         VALUES ($pds, '$name', $quan, '$date')";
                $sql5 = "UPDATE tbl_pds SET quantity='$quan' 
                         WHERE pds_no='$pds' AND stock_name='$name'";
...
<body>
    <div class="sidebar">
        <div class="logo-details">
            <img src="./images/logo2.png" height="40px" style="margin-left: 10px">
        ...
        <ul class="nav-links">
            ...
            <li><a href="#" class="giveration.php"><i class="bx bx-coin-stack"></i><span class="links_name">Give Stock</span></a></li>
            <li><a href="applied_stock.php"><i class='bx bx-list-ul'></i><span class="links_name">View Applied Stock</span></a></li>
            <li><a href="stock_details.php"><i class='bx bx-coin-stack'></i><span class="links_name">Stock Details</span></a></li>
            <li><a href="distributor.php"><i class='bx bx-user'></i><span class="links_name">Distributors Details</span></a></li>
            <li><a href="check_complaints.php"><i class='bx bx-message'></i><span class="links_name">Check Complains</span></a></li>
                    ...
                    <div class="form_container">
                        <form action="" method="post">
                            ...
                            <button type="submit" class="w3-round-large w3-button w3-dark-blue w3-padding"
                                ...
                                Ration to All Distributors</button>

                            <?php
                                if (isset($last_date)) {
                                    echo "<br><br><h4>Note: Last stock assignment was on <b>$last_date</b>. Proceed only if new ration is to be assigned.</h4>";
                                }
                            ?>
                        </form>
                    </div>
